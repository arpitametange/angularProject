...
@Component({
  selector: 'app-dropdown-binding2',
  templateUrl: './dropdown-binding2.component.html',
  styleUrls: ['./dropdown-binding2.component.css']
})
export class DropdownBinding2Component implements OnInit {
